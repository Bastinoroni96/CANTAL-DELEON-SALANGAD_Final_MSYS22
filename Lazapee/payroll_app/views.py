...
def payslips(request):
        ...
        if(request.method=="POST"):
                ...
                cycle_rate = Payslip.getCycleRate()
                ...
                if cycle == '1':
                        pay_cycle1 = 1
                        date_range1 = '1-15'
                        tax1 = (cycle_rate + payroll_allowance + payroll_overtime - Payslip.pag_ibig)*0.2
                        total_pay_Wtax1 = (cycle_rate + payroll_allowance + payroll_overtime - Payslip.pag_ibig)-tax1
                ...
                if cycle == '2':
                        ...
                        tax2 = (cycle_rate + payroll_allowance + payroll_overtime - philhealth - Payslip.sss)*0.2
                        total_pay_Wtax2 = (cycle_rate + payroll_allowance + payroll_overtime - philhealth - Payslip.sss)-tax2
